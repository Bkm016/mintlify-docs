---
title: "语法速查"
description: "Fluxon 语法速查，用于 Agent 提示词"
---

仓库中提供了一份完整的语法速查表，便于在构建 AI Agent 提示词时参考使用：

- [core-syntax.md](https://github.com/TabooLib/fluxon/blob/master/core-syntax.md)：核心语法形态与约束
- [core-syntax.fs](https://github.com/TabooLib/fluxon/blob/master/core-syntax.fs)：完整语法特性与示例
